...
public class TerminalFragment extends Fragment implements SerialInputOutputManager.Listener {
    ...
    private void read()
    {
        ...
        try {
            ...
            // при использовании read with timeout USB bulkTransfer возвращает значение -1 при тайм-ауте и ошибках
            // например, при потере соединения, поэтому обычно при ошибке не возникает исключения
